document.addEventListener('DOMContentLoaded', () => {
  ...
  // --- TRANSLATION SYSTEM ---
  const TRANSLATIONS = {
    "Premium laundry & dry cleaning delivered to your door": "Dịch vụ giặt sấy & giặt hấp cao cấp giao nhận tận nơi",
    "Saigon's premier clothing care service tailored for expats, tourists, and busy professionals. 100% hygienic, eco-friendly detergents, and express 24h turnaround.": "Dịch vụ chăm sóc trang phục hàng đầu Sài Gòn dành cho người nước ngoài, du khách và người bận rộn. Vệ sinh 100%, nước giặt sinh học, giao trả nhanh 24h.",
    "99.9% Sanitized": "Khử trùng 99.9%",
    "Bacteria & Odor Free": "Khử mùi & Diệt khuẩn",
    "24h Turnaround": "Giao trả trong 24h",
    "Express Service Available": "Có gói dịch vụ Hỏa tốc",
    "Schedule Pickup": "Đặt lịch lấy đồ",
    "Check Pricing": "Xem bảng giá",
    "Rated 4.9/5 by 1,500+ expats in Saigon.": "Đánh giá 4.9/5 sao bởi hơn 1.500 expats tại Sài Gòn.",
    "Estimate Your Cost": "Ước tính chi phí",
    "Adjust weight/items to calculate pricing": "Điều chỉnh cân nặng/chất liệu để tính giá",
    "Wash & Fold": "Giặt sấy gấp gọn",
    "Dry Clean": "Giặt hấp cao cấp",
    "Shoe Spa": "Vệ sinh giày hiệu",
    "Laundry Weight": "Cân nặng quần áo",
    "Estimated Total": "Tổng tiền tạm tính",
    "Instant Booking": "Đặt lịch ngay",
    "Pickup": "Nhận đồ",
    "Wash": "Giặt sạch",
    "Dry & Fold": "Sấy & Gấp",
    "Deliver": "Giao trả",
    "PROCESS": "QUY TRÌNH",
    "How 1997 Laundry Works": "Quy trình hoạt động của 1997 Laundry",
    "Professional clothing care in 3 simple steps.": "Chăm sóc trang phục chuyên nghiệp chỉ với 3 bước đơn giản.",
    "Book Online": "Đặt lịch trực tuyến",
    "Schedule your pickup time via WhatsApp/Zalo or our estimator in under 2 minutes.": "Đặt lịch hẹn lấy đồ qua WhatsApp/Zalo hoặc công cụ tính giá trong chưa đầy 2 phút.",
    "Expert Care": "Chăm sóc chuyên nghiệp",
    "We sort by fabric, wash in individual machines, and use premium eco-friendly detergents.": "Chúng tôi phân loại chất liệu vải, giặt bằng máy riêng biệt và dùng nước giặt hữu cơ cao cấp.",
    "Fresh Delivery": "Giao trả sạch thơm",
    "Your garments are neatly folded, packed in reusable bags, and delivered within 24 hours.": "Quần áo được gấp gọn gàng, đóng gói túi đựng tái sử dụng và giao trả trong 24 giờ.",
    "SERVICES": "DỊCH VỤ",
    "Our Clothing Care Capabilities": "Khả năng chăm sóc trang phục của chúng tôi",
    "High-quality treatment tailored to every fabric type.": "Chăm sóc chất lượng cao phù hợp với từng chất liệu vải.",
    "Standard Wash & Fold": "Giặt sấy tiêu chuẩn",
    "For everyday clothing & sheets": "Dành cho quần áo thường ngày & drap giường",
    "Premium Dry Cleaning": "Giặt hấp cao cấp",
    "For suits, silks, and formal wear": "Dành cho vest, lụa và đồ lễ tiệc",
    "Professional Shoe Spa": "Spa giày chuyên nghiệp",
    "Deep cleaning & restoration": "Làm sạch sâu & phục hồi",
    "Household Bedding": "Chăn ga gối nệm gia đình",
    "For quilts, blankets & curtains": "Dành cho mền, chăn & rèm cửa",
    "Daily Wash, Dry & Fold": "Giặt sấy gấp gọn hằng ngày",
    "Clean clothes, ready to wear. We separate whites and colors and wash in individual modern machines.": "Quần áo sạch sẽ, sẵn sàng mặc. Chúng tôi giặt riêng đồ trắng và màu bằng máy riêng biệt hiện đại.",
    "100% Sanitized and scented softener options": "Tiêu chuẩn diệt khuẩn 100% và xả hương tùy chọn",
    "Eco-friendly, skin-safe detergents": "Nước giặt hữu cơ, an toàn cho da nhạy cảm",
    "Sorted, neatly folded & packed by fabric type": "Được phân loại, gấp gọn gàng & đóng gói theo chất liệu vải",
    "Standard Return": "Giao trả tiêu chuẩn",
    "Express Delivery": "Giao trả hỏa tốc",
    "Premium Delicate Dry Cleaning": "Giặt hấp chất liệu mỏng cao cấp",
    "Gentle, solvent-based deep clean for high-value suits, dresses, silk, wool, and activewear garments.": "Giặt sâu dịu nhẹ bằng dung môi cao cấp cho vest giá trị cao, đầm váy, lụa, len và trang phục thể thao.",
    "Protects colors & fabric fibers from shrinking": "Bảo vệ màu sắc & sợi vải không bị co rút",
    "Removes tough oil-based stains and body odors": "Tẩy sạch vết dầu cứng đầu và mùi cơ thể",
    "Delivered on hangers with breathable dust covers": "Giao trả kèm móc treo và túi chống bụi thông thoáng",
    "Ready in 48-72h": "Giao trả trong 48h-72h",
    "Premium Solvent Wash": "Dung môi giặt hấp cao cấp",
    "Professional Hand-Cleaned Shoe Spa": "Spa chăm sóc giày thủ công chuyên nghiệp",
    "Give your sneakers, leather boots, and suede shoes the 5-star hand-cleaning treatment.": "Chăm sóc giày thể thao, giày da và da lộn của bạn với quy trình giặt tay 5 sao.",
    "100% hand wash using specialized premium cleaners": "Giặt tay 100% bằng dung dịch vệ sinh chuyên dụng",
    "UVC sterilization & ozone deodorizing treatments": "Khử trùng tia UVC & khử mùi Ozone chuyên sâu",
    "Natural slow air dry to maintain shape & structure": "Sấy khô tự nhiên chậm để giữ phom dáng & cấu trúc",
    "Ready in 48h": "Giao trả trong 48h",
    "Biological Cleansing": "Làm sạch bằng dung dịch sinh học",
    "Heavy Household Linens & Bedding": "Giặt chăn ga gối nệm gia đình nặng",
    "Deep washing and high-temperature sanitizing for duvets, blankets, toppers, and curtains.": "Giặt sâu và khử trùng ở nhiệt độ cao cho mền, chăn, topper và rèm cửa.",
    "High-temperature washes to eliminate dust mites & allergens": "Giặt nhiệt độ cao tiêu diệt bụi mịn & tác nhân dị ứng",
    "Premium industrial dryers for fluffiness & fresh scents": "Sấy công nghiệp cao cấp giúp chăn mền tơi xốp, thơm tho",
    "Eco-friendly sanitizers safe for children & pets": "Dung dịch khử trùng sinh học an toàn cho trẻ nhỏ & thú cưng",
    "Ready in 24-48h": "Giao trả trong 24h-48h",
    "Deep Sanitation": "Khử trùng chuyên sâu",
    "MEET THE TEAM": "ĐỘI NGŨ CỦA CHÚNG TÔI",
    "Our Clothing Care Experts": "Chuyên gia chăm sóc trang phục",
    "Shop Manager": "Quản lý cửa hàng",
    "Lead Wash Specialist": "Chuyên viên giặt chính",
    "Dry Cleaning Expert": "Chuyên gia giặt hấp",
    "Shoe Spa Artisan": "Nghệ nhân Shoe Spa",
    "Quality Inspector": "Kiểm định chất lượng",
    "Express Delivery Rider": "Tài xế giao hàng hỏa tốc",
    "Fabric Care Consultant": "Tư vấn chăm sóc vải",
    "Pressing & Ironing Master": "Thợ ủi hơi nước chuyên nghiệp",
    "The dedicated hands ensuring your garments receive the highest level of premium care.": "Những bàn tay tận tụy chăm sóc từng bộ trang phục của bạn ở mức tốt nhất.",
    "WHY 1997 LAUNDRY": "TẠI SAO CHỌN 1997 LAUNDRY",
    "The Premium Clean Difference": "Sự khác biệt từ dịch vụ giặt sấy cao cấp",
    "We treat clothing care as a craft, not just a service.": "Chúng tôi xem chăm sóc trang phục là một nghệ thuật, không chỉ là dịch vụ.",
    "100% Separate Washing": "Giặt riêng biệt 100%",
    "We never mix your garments with other guests. Each customer gets dedicated machines.": "Tuyệt đối không giặt chung đồ của bạn với khách khác. Mỗi khách một máy riêng biệt.",
    "RO Purified Water": "Nước lọc tinh khiết RO",
    "We wash with RO filtered water to prevent discoloration and preserve fabric brightness.": "Chúng tôi giặt bằng nước lọc tinh khiết RO giúp bảo vệ màu sắc và độ sáng của vải.",
    "Eco Detergents Only": "Nước giặt hữu cơ sinh học",
    "Dermatologically tested, baby-safe, and biodegradable premium organic soaps.": "Xà phòng hữu cơ cao cấp đã kiểm nghiệm da liễu, an toàn cho bé và thân thiện môi trường.",
    "4h Express Service": "Hỏa tốc giao nhận 4h",
    "Urgent checkout or checkout flight? We collect, wash, and return in under 4 hours.": "Bạn gấp check-out hoặc bay? Chúng tôi giao nhận, giặt sấy trả đồ trong dưới 4 giờ.",
    "THE 1997 BENEFITS": "ĐẶC QUYỀN TỪ 1997 LAUNDRY",
    "Five-Star Hotel Laundry Experience": "Trải nghiệm giặt sấy chuẩn khách sạn 5 sao",
    "Enjoy premium benefits designed specifically for travelers and busy professionals in Saigon.": "Tận hưởng các đặc quyền được thiết kế riêng cho khách du lịch và người bận rộn tại Sài Gòn.",
    "Free Reception Pickup & Delivery": "Giao nhận miễn phí tại quầy lễ tân",
    "Drop your bag at your hotel concierge desk, message us, and we will handle the rest.": "Gửi đồ tại quầy lễ tân, nhắn tin cho chúng tôi và tài xế sẽ lo phần còn lại.",
    "24/7 Customer Support": "Hỗ trợ khách hàng 24/7",
    "Always online on Zalo and WhatsApp to answer questions, modify schedules, and update order status.": "Luôn túc trực trên Zalo và WhatsApp để giải đáp, thay đổi lịch và báo trạng thái đơn hàng.",
    "Time-critical check out guarantee": "Cam kết giao đồ đúng giờ trả phòng",
    "WHAT CUSTOMERS SAY": "ĐÁNH GIÁ TỪ KHÁCH HÀNG",
    "Loved by Expats & Tourists": "Được yêu thích bởi Expats & Du khách",
    "Don't just take our word for it. Read reviews from real travelers in Saigon.": "Hãy xem đánh giá thực tế từ khách du lịch đã trải nghiệm dịch vụ tại Sài Gòn.",
    "Best laundry in HCMC! They picked up my clothes from Caravelle Hotel reception desk and returned them clean and smelling amazing in 24 hours. Saving 80% compared to hotel rates!": "Dịch vụ giặt tốt nhất TP.HCM! Họ lấy đồ từ quầy lễ tân Caravelle và giao lại sạch thơm sau 24h. Tiết kiệm 80% so với giá khách sạn!",
    "Traveler": "Khách du lịch",
    "Cleaned my designer sneakers perfectly by hand. They look brand new. Professional and fast.": "Vệ sinh đôi giày hiệu của tôi bằng tay rất sạch. Giày trông như mới. Chuyên nghiệp và nhanh chóng.",
    "Digital Nomad": "Làm việc từ xa",
    "Amazing 4-hour express service. Saved me right before my checkout flight. Smells very fresh!": "Dịch vụ hỏa tốc 4h tuyệt vời. Cứu tôi bàn thua trông thấy trước giờ bay. Thơm tho sạch sẽ!",
    "Business Traveler": "Khách công tác",
    "We had our thick duvet and sheets washed here. Very soft, clean, and fast turnaround.": "Chúng tôi đã giặt chăn mền và ga giường ở đây. Rất mềm mại, sạch sẽ và giao trả nhanh.",
    "Resident expat": "Người nước ngoài lưu trú",
    "READY FOR A FRESH WASH?": "BẠN ĐÃ SẴN SÀNG GIẶT SẠCH THƠM?",
    "Experience Saigon's Premium Clothing Care": "Trải nghiệm dịch vụ giặt sấy cao cấp Sài Gòn",
    "Enjoy separation wash, RO water filtration, and express hotel delivery in under 24 hours.": "Trải nghiệm giặt riêng 100%, lọc nước tinh khiết RO và giao trả tận nơi dưới 24h.",
    ...
    "Separate white clothes (+30,000 VND)": "Giặt riêng đồ trắng (+30.000 VND)",
    "Express 24h Shoes (+100,000 VND/pair)": "Giặt giày hỏa tốc 24h (+100.000 VND/đôi)",
    "Proceed to Book via WhatsApp": "Tiến hành đặt qua WhatsApp",
    "Proceed to Book via Zalo": "Tiến hành đặt qua Zalo",

    // booking.html Right Column
    "Live Estimation Summary": "Bảng ước tính chi tiết",
    "The live estimator calculates your total cost instantly in VND and USD.": "Công cụ tính giá trực tiếp sẽ hiển thị tổng chi phí tức thì bằng VND và USD.",
    "SPECIAL ONLINE OFFER": "ƯU ĐÃI ĐẶT LỊCH ONLINE",
    "Get a premium detergent upgrade, separate whites sorting, and 15-minute quick reply via Zalo or WhatsApp!": "Nhận ưu đãi nâng cấp nước giặt cao cấp, phân loại đồ trắng và phản hồi nhanh trong 15 phút qua Zalo hoặc WhatsApp!",
    "Why book with 1997 Laundry?": "Vì sao chọn đặt tại 1997 Laundry?",
    "Fast WhatsApp/Zalo confirmation in 15 minutes": "Xác nhận qua WhatsApp/Zalo nhanh trong 15 phút",
    "Free lobby pickup & return delivery (up to 3km)": "Miễn phí giao nhận tại sảnh (lên đến 3km)",
    "100% separate washes for every customer": "Cam kết giặt riêng 100% bằng máy độc lập",
    "Transparent dynamic pricing (no hidden surcharges)": "Bảng giá tự động tính rõ ràng (không phụ phí ẩn)",

    // pay.html
    "Confirm Booking": "Xác nhận đơn hàng",
    ...
    "WALKING DIRECTIONS": "HƯỚNG DẪN ĐƯỜNG ĐI BỘ",
    "Lobby Collection Option": "Tùy chọn gửi đồ tại Sảnh",
    "Don't feel like walking? You can easily book our free lobby collection service in 15 seconds:": "Bạn ngại đi bộ? Hãy đặt dịch vụ giao nhận tại sảnh miễn phí chỉ trong 15 giây:",
    "Message us on Zalo or WhatsApp with your name and booking code.": "Nhắn tin cho chúng tôi qua Zalo hoặc WhatsApp kèm tên và mã đặt lịch của bạn.",
    "Our driver collects the bag directly from reception - no physical contact required.": "Tài xế của chúng tôi sẽ nhận túi đồ trực tiếp từ lễ tân - không cần gặp mặt tiếp xúc trực tiếp.",
    "Book Lobby Pickup Now": "Đặt lấy đồ tại Sảnh ngay",
    
    // Caravelle
    "Directions from Caravelle Hotel Saigon": "Hướng dẫn đường đi từ Caravelle Hotel Saigon",
    "Follow this simple step-by-step route to walk from Caravelle Hotel Saigon lobby to 1997 Laundry, or select our lobby collection option.": "Đi theo lộ trình đơn giản từng bước này để đi bộ từ sảnh Caravelle Hotel Saigon đến 1997 Laundry, hoặc chọn gửi đồ tại sảnh.",
    "Walk Route (a 6-minute walk (500m))": "Tuyến đường đi bộ (6 phút đi bộ (500m))",
    "Exit Caravelle main entrance onto Lam Son Square, walk past the Opera House.": "Đi ra khỏi cổng chính Caravelle vào Công trường Lam Sơn, đi qua Nhà hát Thành phố.",
    "Cross Dong Khoi Street and head north on Hai Ba Trung Street.": "Băng qua đường Đồng Khởi và đi thẳng theo hướng bắc đường Hai Bà Trưng.",
    "Turn left onto Le Thanh Ton Street and walk straight for 100 meters.": "Rẽ trái vào đường Lê Thánh Tôn và đi thẳng khoảng 100 mét.",
    "Turn right into Alley 15B (Hẻm 15B) and walk 30 meters. 1997 Laundry is on your right.": "Rẽ phải vào Hẻm 15B Lê Thánh Tôn, đi tiếp 30 mét. 1997 Laundry nằm bên tay phải của bạn.",
    "Pack your clothes in any bag and leave it with the Caravelle Hotel Saigon front desk / concierge.": "Đóng gói quần áo của bạn vào bất kỳ túi nào và gửi tại quầy lễ tân / concierge của Caravelle Hotel Saigon.",
    ...
    // Sheraton
    "Directions from Sheraton Saigon Hotel": "Hướng dẫn đường đi từ Sheraton Saigon Hotel",
    "Follow this simple step-by-step route to walk from Sheraton Saigon Hotel lobby to 1997 Laundry, or select our lobby collection option.": "Đi theo lộ trình đơn giản từng bước này để đi bộ từ sảnh Sheraton Saigon Hotel đến 1997 Laundry, hoặc chọn gửi đồ tại sảnh.",
    "Walk Route (a 5-minute walk (450m))": "Tuyến đường đi bộ (5 phút đi bộ (450m))",
    "Exit Sheraton lobby onto Dong Khoi Street and head north towards the Opera House.": "Đi ra khỏi sảnh Sheraton vào đường Đồng Khởi và đi về hướng bắc về phía Nhà hát Thành phố.",
    "Continue straight onto Hai Ba Trung Street.": "Đi thẳng tiếp vào đường Hai Bà Trưng.",
    "Turn right into Alley 15B (Hẻm 15B) and find 1997 Laundry 30 meters inside on the right.": "Rẽ phải vào Hẻm 15B Lê Thánh Tôn, đi tiếp 30 mét. 1997 Laundry nằm bên tay phải của bạn.",
    "Pack your clothes in any bag and leave it with the Sheraton Saigon Hotel front desk / concierge.": "Đóng gói quần áo của bạn vào bất kỳ túi nào và gửi tại quầy lễ tân / concierge của Sheraton Saigon Hotel.",
    ...
    // Rex
    "Directions from Rex Hotel Saigon": "Hướng dẫn đường đi từ Rex Hotel Saigon",
    "Follow this simple step-by-step route to walk from Rex Hotel Saigon lobby to 1997 Laundry, or select our lobby collection option.": "Đi theo lộ trình đơn giản từng bước này để đi bộ từ sảnh Rex Hotel Saigon đến 1997 Laundry, hoặc chọn gửi đồ tại sảnh.",
    "Walk Route (a 7-minute walk (600m))": "Tuyến đường đi bộ (7 phút đi bộ (600m))",
    "Exit Rex Hotel lobby onto Nguyen Hue Walking Street and head north.": "Đi ra khỏi sảnh Rex Hotel vào Phố đi bộ Nguyễn Huệ và đi về phía bắc.",
    "Turn right onto Le Thanh Ton Street and walk straight (past Vincom Center).": "Rẽ phải vào đường Lê Thánh Tôn và đi thẳng (qua trung tâm Vincom).",
    "Cross Dong Khoi Street, and keep walking straight until you reach Alley 15B (Hẻm 15B) on your left.": "Băng qua đường Đồng Khởi, tiếp tục đi thẳng cho đến khi thấy Hẻm 15B Lê Thánh Tôn bên tay trái.",
    "Walk 30 meters down the alley; 1997 Laundry is on your right.": "Đi thẳng vào hẻm 30 mét; 1997 Laundry nằm bên tay phải của bạn.",
    "Pack your clothes in any bag and leave it with the Rex Hotel Saigon front desk / concierge.": "Đóng gói quần áo của bạn vào bất kỳ túi nào và gửi tại quầy lễ tân / concierge của Rex Hotel Saigon.",
    ...
    // Park Hyatt
    "Directions from Park Hyatt Saigon": "Hướng dẫn đường đi từ Park Hyatt Saigon",
    "Follow this simple step-by-step route to walk from Park Hyatt Saigon lobby to 1997 Laundry, or select our lobby collection option.": "Đi theo lộ trình đơn giản từng bước này để đi bộ từ sảnh Park Hyatt Saigon đến 1997 Laundry, hoặc chọn gửi đồ tại sảnh.",
    "Walk Route (a 5-minute walk (400m))": "Tuyến đường đi bộ (5 phút đi bộ (400m))",
    "Exit Park Hyatt main lobby onto Lam Son Square.": "Đi ra khỏi sảnh chính Park Hyatt vào Công trường Lam Sơn.",
    "Turn right onto Hai Ba Trung Street and walk north for one block.": "Rẽ phải vào đường Hai Bà Trưng và đi về hướng bắc một ngã tư.",
    "Pack your clothes in any bag and leave it with the Park Hyatt Saigon front desk / concierge.": "Đóng gói quần áo của bạn vào bất kỳ túi nào và gửi tại quầy lễ tân / concierge của Park Hyatt Saigon.",
